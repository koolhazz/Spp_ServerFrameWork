...
/*************************************************
  ...
  Others:
*************************************************/
int CIniFile::OpenFile(const char *pszFilename)
{
    FILE    *fp;
    size_t  len;
    int     result;
    ...
    if (NULL == pszFilename)
    {
    	//errLog("[%s][%d] NULL == pszFilename",__FILE__, __LINE__);	
        return -1;
    }
    ...
    if (NULL == fp)
    {
    	//errLog("[%s][%d] NULL == fp",__FILE__, __LINE__);
        return -1;
    }
    ...
    {
        fclose(fp);
        //errLog("[%s][%d] 0 != result",__FILE__, __LINE__);
        return -1;
    }
    ...
    {
        fclose(fp);
        //errLog("[%s][%d](NULL == m_pszContent) || (NULL == m_pszShadow)",__FILE__, __LINE__);
        return -1;
    }
...
*************************************************/
unsigned int CIniFile::GetItemValue( const char *pszSectionName,
...
/*************************************************
  ...
  Others:       本函数不是UNICODE版本
*************************************************/
unsigned int CIniFile::SetItemValue( const char *pszSectionName,
                                   const char *pszKeyName,
                                   int lKeyValue )
{
    char szBuf[100];
...
/*************************************************
  ...
  Others:       本函数不是UNICODE版本
*************************************************/
unsigned int CIniFile::LocateSection( const char *pszSectionName,
...
/*************************************************
  ...
  Others:       本函数不是UNICODE版本
*************************************************/
unsigned int CIniFile::LocateKeyRange( const char *pszKeyName,
...
/*************************************************
  ...
  Others:       本函数不是UNICODE版本
*************************************************/
unsigned int CIniFile::LocateKeyValue( const char *pszKeyName,
                                   const char *pszSectionBegin,
                                   const char *pszSectionEnd,
                                   char * &pszValueBegin,
                                   char * &pszValueEnd )
...
/*************************************************
  ...
  Others:
*************************************************/
char *CIniFile::LocateStr( const char *pszCharSet,
                              const char *pszBegin,
                              const char *pszEnd )
{
    char *pFind;
...
char *CIniFile::SearchMarchStr(const char *pszBegin, const char *pszCharSet)
{
	char *pFind;
	char *pFind1;
...
/*************************************************
  ...
  Others:
*************************************************/
char *CIniFile::MapToContent(const char *p)
{
...
/*************************************************
  ...
  Others:
*************************************************/
char *CIniFile::MapToShadow(const char *p)
{
...
/*************************************************
  ...
  Others:
*************************************************/
void CIniFile::ToLower( char * pszSrc, size_t len)
{
    BYTE    cb;
    size_t  i;
